...
class Game {
    constructor(canvasId) {
      ...
      this.currentWave = 1;
      this.zombieConfigs = [
        { speed: 45, health: 40, color: "green" },
        { speed: 50, health: 50, color: "darkgreen" },
        { speed: 40, health: 60, color: "brown" },
        { speed: 60, health: 35, color: "red" },
        { speed: 35, health: 70, color: "purple" },
        { speed: 55, health: 55, color: "orange" },
        { speed: 50, health: 65, color: "blue" },
        { speed: 65, health: 30, color: "pink" },
        { speed: 30, health: 80, color: "gray" },
        { speed: 70, health: 25, color: "black" },
      ];
